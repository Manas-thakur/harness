...
Phi is being built as a Python implementation of Pi's minimalist coding-agent harness architecture.
...
13. Phi home, paths, and automatic `.agents` resources.
...
Phase 0 creates the docs, package scaffold, development checks, and a basic `phi --version` command.
