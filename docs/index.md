...
Phi is a Python implementation of Pi's minimalist coding-agent harness architecture.
...
- development tooling
- a `phi` console command that opens the Textual TUI by default
...
- stored Phi credentials with environment-variable fallback
...
- Installing Phi as a command? Read [Installation](installation.md).
