...
The built-in coding tools in `src/phi_coding/tools.py` have detailed Python
docstrings, and Phi also has beginner-friendly tool documentation in
`docs/03-tools.md`.
...
Phi's docs currently serve two different audiences:
...
Generated API documentation can be added later if Phi needs a formal API
...
that Phi needs while the architecture is still evolving.
...
If Phi later adopts generated docstring documentation, the generated pages
should:
