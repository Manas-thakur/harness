"""Built-in provider catalog for Phi login/setup flows."""

from dataclasses import dataclass
from typing import Literal

from phi_ai.env import DEFAULT_OLLAMA_BASE_URL
from phi_coding.thinking import ThinkingLevel, ThinkingParameter
...
class ProviderCatalogEntry:
    """A built-in provider Phi can present during login."""
