...
from phi_agent.messages import AssistantMessage
from phi_agent.tools import ToolCall
...
class ProviderToolSupportEvent(BaseModel):
    """The provider has disabled tool support for this model mid-stream."""

    model_config = ConfigDict(extra="forbid")

    type: Literal["tool_support"] = "tool_support"
    supported: bool
